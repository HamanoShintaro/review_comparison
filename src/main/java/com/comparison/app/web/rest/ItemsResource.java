...
public class ItemsResource {
     ...
     */
    @GetMapping("/items")
    public List<Items> getAllItems(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get all Items");
        return itemsRepository.findAllWithEagerRelationships();
    }
    ...
    public ResponseEntity<Items> getItems(@PathVariable Long id) {
        ...
        Optional<Items> items = itemsRepository.findOneWithEagerRelationships(id);
