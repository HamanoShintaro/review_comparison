...
public class ItemsResourceIntTest {
    ...
    public void getAllItemsWithEagerRelationshipsIsEnabled() throws Exception {
        ItemsResource itemsResource = new ItemsResource(itemsRepositoryMock);
        when(itemsRepositoryMock.findAllWithEagerRelationships(any())).thenReturn(new PageImpl(new ArrayList<>()));
        ...
        verify(itemsRepositoryMock, times(1)).findAllWithEagerRelationships(any());
    }
